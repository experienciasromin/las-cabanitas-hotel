...
import RoomCardExpedia from './RoomCardExpedia';
...
export default function RoomBooking({ suiteImage, showToast }: RoomBookingProps) {
  ...
  return (
    <>
      {/* ========================================================================= */}
      {/* BLOQUE 1: NUESTROS REFUGIOS DE MONTAÑA (ESTILO CATÁLOGO MULTI-HABITACIÓN)  */}
      {/* ========================================================================= */}
      <section 
        id="habitaciones" 
        className="w-full py-12 sm:py-16 bg-wood-950 relative overflow-hidden text-charcoal-900"
      >
        ...
        <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
            ...
            <p className="text-charcoal-300 text-xs sm:text-sm md:text-base leading-relaxed">
              Selecciona tu cabaña favorita para cotizar y reservar al instante con tarifas garantizadas y confirmación inmediata.
            </p>
          </div>

          {/* Grid de Habitaciones (Mínimo 3-4 en pantalla) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 items-stretch">
            {rooms.map((room, idx) => (
              <RoomCardExpedia
                ...
                onSelect={handleDirectReserve}
              />
            ))}
          </div>

          {/* Guarantee banner under rooms */}
          <div className="mt-10 p-4 sm:p-5 rounded-2xl bg-wood-900/60 border border-gold-500/20 backdrop-blur-md flex flex-wrap items-center justify-around gap-4 text-center sm:text-left text-white text-xs">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-full bg-gold-500/20 text-gold-400 flex items-center justify-center font-bold">✓</div>
              <div>
                <span className="font-bold block text-gold-400 text-sm">Mejor Tarifa Directa</span>
                <span className="text-charcoal-400 text-[11px]">Sin cargos ocultos ni comisiones de terceros</span>
              </div>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-full bg-gold-500/20 text-gold-400 flex items-center justify-center font-bold">★</div>
              <div>
                <span className="font-bold block text-gold-400 text-sm">Cancelación Flexible</span>
                <span className="text-charcoal-400 text-[11px]">Modificaciones y soporte personalizado vía WhatsApp</span>
              </div>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-full bg-gold-500/20 text-gold-400 flex items-center justify-center font-bold">⚡</div>
              <div>
                <span className="font-bold block text-gold-400 text-sm">Confirmación Inmediata</span>
                <span className="text-charcoal-400 text-[11px]">Registro sincronizado en tiempo real</span>
              </div>
            </div>
          </div>
